...
ALLOWED_HOSTS = ['config-j5tf.onrender.com'] # Keep your Render domain
...
DATABASES = {
    'default': {
        ...
        'HOST': 'dpg-d307ba15pdvs73f70bpg-a.oregon-postgres.render.com',  # use external host
        'PORT': '5432',
    }
}
...
STATIC_URL = '/static/' # Removed duplicate
